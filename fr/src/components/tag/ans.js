          ...
          <div class="d-flex justify-content-end">
            <div  class="question_box col-xl-8 col-lg-8 col-md-11 col-sm-12 col-12 p-2 d-flex flex-column">
              ...
              <div class="like_box col-2 px-3 ms-3 mt-1">
                <div class="like">
                <svg onClick={()=>{setScore(score=>score+1);inc()}}  class="like" width="20" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
                ...
                <div class="like">
                <svg onClick={()=>{setScore(score=>score-1);;dec()}}   class="like" width="20" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
