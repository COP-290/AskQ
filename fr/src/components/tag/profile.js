...
<div class="row d-flex justify-content-center mt-3">
  ...
  <div class="username d-flex justify-content-center col-5" style={{"font-size": "35px"}}>
    <div class="input-group mb-3" >
        ...
        <input type="text" disabled class="form-control"  value={detail?detail[1]:""} aria-label="Username" aria-describedby="basic-addon1"></input>
    </div>
  </div>
  ...
  <div class="user ID d-flex justify-content-center col-5" style={{"font-size": "35px"}}>
    <div class="input-group mb-3">
        ...
        <input type="text" disabled class="form-control" value={detail?detail[0]:""} aria-label="User ID" aria-describedby="basic-addon1"></input>
    </div>
  </div>
  ...
  <div class="input-group mb-3">
        ...
        <input type="text" disabled class="form-control" value={detail?detail[3]:""} aria-label="User ID" aria-describedby="basic-addon1"></input>
    </div>
  </div>
...
<div class="Reputation d-flex justify-content-center col-5" style={{"font-size": "35px"}}>
    <div class="input-group mb-3">
        ...
        <input type="text" disabled class="form-control" value={detail?detail[6]:""} aria-label="Reputation" aria-describedby="basic-addon1"></input>
    </div>
  </div>
  ...
  <div class="Up Vote d-flex justify-content-center col-5" style={{"font-size": "35px"}}>
    <div class="input-group mb-3">
        ...
        <input type="text" disabled class="form-control" value={detail?detail[7]:""} aria-label="Up Vote" aria-describedby="basic-addon1"></input>
    </div>
  </div>
  <div class="Down Vote d-flex justify-content-center col-5" style={{"font-size": "35px"}}>
    <div class="input-group mb-3">
        ...
        <input type="text" disabled class="form-control" value={detail?detail[8]:""} aria-label="Down Vote" aria-describedby="basic-addon1"></input>
    </div>
  </div>
</div>
<hr/>
...
<div class="aboutme_row row d-flex justify-content-center">
  <div class="col-8">
    <div class="input-group">
      ...
      <textarea disabled={text} id="aboutme" onChange={(e) => handleInputChange(e)} name="content" class="form-control q_body" aria-label="Body" defaultValue={detail?detail[2]:""}></textarea>
    </div>
  </div>
