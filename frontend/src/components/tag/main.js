export default function Main(){
    ...
    <div class="question_box_main p-3">
        ...
        <hr/>
        <a class="question" style={{"font-size": "larger", "font-weight": "bold","cursor":"pointer"}}  
        // onClick={()=>{to(`question/${value[0][0]}`)}}
        href="/question/90"
        >
        ...
        <div class="answer" style={{" font-size": "larger","color": "rgb(88, 88, 88);" }}> 
            ...
            <div dangerouslySetInnerHTML={{__html:String.raw`<p>Are there any really good tutorials explaining <a href="http://svnbook.red-bean.com/en/1.8/svn.branchmerge.html" rel="nofollow">branching and merging</a> with Apache Subversion? </p>
...
`}} />
    ...
    <div class="question_box_main p-3">
        ...
        <div class="answer" style={{" font-size": "larger","color": "rgb(88, 88, 88);" }}> 
            ...
            <div dangerouslySetInnerHTML={{__html:String.raw`
