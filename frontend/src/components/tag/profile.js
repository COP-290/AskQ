...
{/* <div class="aboutme_row row d-flex justify-content-center">
  <div class="col-8">
    <div class="input-group">
      ...
      <textarea disabled={text} id="aboutme" onChange={(e) => handleInputChange(e)} name="content" class="form-control q_body" aria-label="Body" defaultValue={'Think more - code less, or think less - code more? Love a clean program, where you can tell each functions meaning, each class\'s responsibilities, each variable\'s purpose'}></textarea>
    </div>
  </div>
</div> */}
