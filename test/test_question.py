...
a4=5
a5=[[(94, 63, datetime.datetime(2010, 8, 1, 15, 45, 37), 123, 'Double is too muvh ', 'Is body necessary for all part is'), ['Java']], [(91, 62, datetime.datetime(2007, 8, 2, 15, 45, 37), 99, 'Python', 'Its body is not about SQL but about python'), ['C++']], [(90, 66, datetime.datetime(2007, 8, 1, 14, 45, 37), 98, 'SQL', 'Its body is about SQL'), ['Python']]]

a6=[[(94, 63, datetime.datetime(2010, 8, 1, 15, 45, 37), 123, 'Double is too muvh ', 'Is body necessary for all part is'), ['Java']], [(91, 62, datetime.datetime(2007, 8, 2, 15, 45, 37), 99, 'Python', 'Its body is not about SQL but about python'), ['C++']], [(90, 66, datetime.datetime(2007, 8, 1, 14, 45, 37), 98, 'SQL', 'Its body is about SQL'), ['Python']]]
...
from flask_blog.question import pagefunction_number,sort_quesbyTag,question_from_list_of_tag_ml,question_from_list_of_tag_number,question_from_list_of_tag
